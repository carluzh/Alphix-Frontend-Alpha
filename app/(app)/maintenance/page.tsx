...
export default function MaintenancePage() {
  ...
  return (
    <div className="relative min-h-screen p-6">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg z-10">
        ...
        <div className="rounded-lg bg-muted/30 border border-sidebar-border/60 p-8">
          <div className="text-center">
            <h1 className="text-lg font-semibold mb-4">Site Under Maintenance</h1>
            <p className="text-xs text-muted-foreground leading-relaxed mb-6">
              We're performing scheduled maintenance to improve your experience. Follow us on Discord or Twitter for updates on when we'll be back online.
            </p>
