...
/**
 * Skeleton components for the Overview page
...
/**
 * Overview Header Skeleton - matches the responsive 3/2/1 card layout
 */
export const OverviewHeaderSkeleton = ({ viewportWidth = 1440 }: { viewportWidth?: number }) => {
