...
import { OverviewTickBar } from "@/components/overview/OverviewTickBar";
import { OverviewHeaderSkeleton } from "./skeletons";
...
/**
 * Overview header component - displays value, stats, and asset allocation
...
export function OverviewHeader({
  ...
  if (showSkeleton) {
    return <OverviewHeaderSkeleton viewportWidth={viewportWidth} />;
  }
