...
import type { PortfolioData } from "../hooks";
...
interface PositionsSectionProps {
  ...
  convertTickToPrice: (tick: number, currentPoolTick: number | null, currentPrice: string | null, baseToken: string, token0Symbol: string, token1Symbol: string) => string;
...
export function PositionsSection({
  ...
  }, [aprByPoolId, portfolioData.priceMap, batchFeesData, tokenDefinitions]);
