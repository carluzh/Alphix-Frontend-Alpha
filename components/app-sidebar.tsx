          ...
          <SidebarGroup>
            ...
            <SidebarMenu className="mt-1 flex flex-col gap-0 px-2.5">
                <SidebarMenuItem className="list-none">
                  <SidebarMenuButton
                    asChild
                    className="w-full rounded-lg px-1.5 py-1 transition-colors text-muted-foreground hover:text-white"
                  >
                    <a href="https://alphix.gitbook.io/docs/" target="_blank" rel="noopener noreferrer" className="flex items-center">
                      ...
                      <span className="flex-1 truncate ml-2.5 text-xs font-normal">Documentation</span>
                    </a>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem className="list-none">
                  ...
                  >
                    <a href="https://x.com/AlphixFi" target="_blank" rel="noopener noreferrer" className="flex items-center">
                      ...
                      <span className="flex-1 truncate ml-2.5 text-xs font-normal">Twitter</span>
                    </a>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem className="list-none">
                  ...
                  >
                    <a href="https://discord.gg/NTXRarFbTr" target="_blank" rel="noopener noreferrer" className="flex items-center">
                      ...
                      <span className="flex-1 truncate ml-2.5 text-xs font-normal">Discord</span>
                    </a>
                  </SidebarMenuButton>
                </SidebarMenuItem>
              </SidebarMenu>
