...
export interface OverviewTickBarProps {
...
export function OverviewTickBar({ composition, onHover, hoveredSegment, containerRef, netApyRef, layout = "inline", handleRestClick, setIsRestCycling, isRestCycling, restCycleIndex, forceHideLabels, onApplySort, onHoverToken, activeTokenFilter, setActiveTokenFilter }: OverviewTickBarProps) {
